...
<html>
  ...
  <body>
	  ...
	  <a href="prof-addData.html">Add Questions</a>
	  <a href="prof-createSyllabus.html">Create Syllabus</a>
	  <a class="active" href="prof-createCourse.html">Create a Course</a>
	...
	<div class="content">
		...
		<form action="" method="post">
			<label for="newCourseNumber">New Course Number: </label><br>
