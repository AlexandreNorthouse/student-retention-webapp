    ...
    <body>
        ...
        <div class="content">
            ...
            <form action="" method="post">
                ...
                <input type="text" name="courseNumber" placeholder="PSYC101" required value="
                    <?php if(!empty($_POST['courseNumber'])){ echo $_POST['courseNumber']; } else { echo ''; } ?>"/>
                <br><br>

                <label for="courseSection">New Course Section: </label><br>
                <input type="number" name="courseSection" placeholder="1" required min=1 max=255 value="
                    <?php if(!empty($_POST['courseSection'])){ echo $_POST['courseSection']; } else { echo ''; } ?>"/>
                <br><br>

                <label for="courseName">New Course Name: </label><br>
                <input type="text" name="courseName" placeholder="Intro to Psychology" required value="
                    <?php if(!empty($_POST['courseName'])){ echo $_POST['courseName']; } else { echo ''; } ?>"/>
                <br><br>
